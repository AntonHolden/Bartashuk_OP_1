...
public class Tests
{
    ...
    public void ParseArgsTest()
    {
        ...
        //That(ParseArgs(new[] { "../../../data/query.ips", "../../../data/1.iprs", "../../../data/2.iprs" }), Is.EqualTo(expected)); // doesn't work
        That(ParseArgs(new[] { "data/query.ips", "data/1.iprs", "data/2.iprs" }).IpsFile, Is.EqualTo(expected.IpsFile));
        That(ParseArgs(new[] { "data/query.ips", "data/1.iprs", "data/2.iprs" }).IprsFiles, Is.EqualTo(expected.IprsFiles));
